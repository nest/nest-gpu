...
exc_conn_dict={"rule": "fixed_total_number", "total_num": n_neurons*CE}
exc_syn_dict={"weight": Wex, "delay": mean_delay, "receptor":0}
...
inh_conn_dict={"rule": "fixed_total_number", "total_num": n_neurons*CI}
inh_syn_dict={"weight": Win, "delay": mean_delay, "receptor":1}
