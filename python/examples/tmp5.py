...
w0 = ngpu.GetConnectionFloatParam(conn_id, "weight")
print(w0)
tgt = ngpu.GetConnectionIntParam(conn_id, "target")
print(tgt)
...
for i in range(N):
    ...
    conn_stat = ngpu.GetConnectionStatus(conn_id)
    print(conn_stat)
    w = w0[i] #conn_stat[0]["weight"]
