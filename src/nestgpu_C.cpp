...
extern "C"
{
  ...
  int
  NESTGPU_CreatePoissonGenerator( int n_node, float rate )
  {
    int ret = 0;
    BEGIN_ERR_PROP
    {
  ...
  int
  NESTGPU_Connect( int i_source_node,
    int i_target_node,
    unsigned char port,
    ...
    float delay )
  {
    ...
    BEGIN_ERR_PROP
    {
      ret = NESTGPU_instance->Connect( i_source_node, i_target_node, port, syn_group, weight, delay );
    }
    END_ERR_PROP return ret;
  }
  ...
  int
  NESTGPU_ConnectSeqSeq( int i_source, int n_source, int i_target, int n_target )
  {
    int ret = 0;
    BEGIN_ERR_PROP
    {
  ...
  int
  NESTGPU_ConnectSeqGroup( int i_source, int n_source, int* i_target, int n_target )
  {
    int ret = 0;
    BEGIN_ERR_PROP
    {
  ...
  int
  NESTGPU_ConnectGroupSeq( int* i_source, int n_source, int i_target, int n_target )
  {
    int ret = 0;
    BEGIN_ERR_PROP
    {
  ...
  int
  NESTGPU_ConnectGroupGroup( int* i_source, int n_source, int* i_target, int n_target )
  {
    int ret = 0;
    BEGIN_ERR_PROP
    {
  ...
  char**
  NESTGPU_GetIntVarNames( int i_node )
  {
    char** ret = NULL;
    BEGIN_ERR_PROP
    {
      ...
      for ( unsigned int i = 0; i < var_name_vect.size(); i++ )
      {
        ...
        std::strncpy( var_name, var_name_vect[ i ].c_str(), vl );
  ...
  char**
  NESTGPU_GetScalVarNames( int i_node )
  {
    char** ret = NULL;
    BEGIN_ERR_PROP
    {
  ...
  int
  NESTGPU_GetNScalVar( int i_node )
  {
    int ret = 0;
    BEGIN_ERR_PROP
    {
  ...
  char**
  NESTGPU_GetPortVarNames( int i_node )
  {
    char** ret = NULL;
    BEGIN_ERR_PROP
    {
  ...
  int
  NESTGPU_GetNPortVar( int i_node )
  {
    int ret = 0;
    BEGIN_ERR_PROP
    {
  ...
  char**
  NESTGPU_GetScalParamNames( int i_node )
  {
    char** ret = NULL;
    BEGIN_ERR_PROP
    {
  ...
  int
  NESTGPU_GetNScalParam( int i_node )
  {
    int ret = 0;
    BEGIN_ERR_PROP
    {
  ...
  char**
  NESTGPU_GetGroupParamNames( int i_node )
  {
    char** ret = NULL;
    BEGIN_ERR_PROP
    {
  ...
  int
  NESTGPU_GetNGroupParam( int i_node )
  {
    int ret = 0;
    BEGIN_ERR_PROP
    {
  ...
  char**
  NESTGPU_GetPortParamNames( int i_node )
  {
    char** ret = NULL;
    BEGIN_ERR_PROP
    {
  ...
  int
  NESTGPU_GetNPortParam( int i_node )
  {
    int ret = 0;
    BEGIN_ERR_PROP
    {
  ...
  char**
  NESTGPU_GetArrayParamNames( int i_node )
  {
    char** ret = NULL;
    BEGIN_ERR_PROP
    {
  ...
  int
  NESTGPU_GetNArrayParam( int i_node )
  {
    int ret = 0;
    BEGIN_ERR_PROP
    {
  ...
  char**
  NESTGPU_GetArrayVarNames( int i_node )
  {
    char** ret = NULL;
    BEGIN_ERR_PROP
    {
  ...
  int
  NESTGPU_GetNArrayVar( int i_node )
  {
    int ret = 0;
    BEGIN_ERR_PROP
    {
  ...
  int*
  NESTGPU_GetSeqSeqConnections( int i_source, int n_source, int i_target, int n_target, int syn_group, int* n_conn )
  {
    int* ret = NULL;
    BEGIN_ERR_PROP
    {
      std::vector< ConnectionId > conn_id_vect =
        NESTGPU_instance->GetConnections( i_source, n_source, i_target, n_target, syn_group );
  ...
  int*
  NESTGPU_GetSeqGroupConnections( int i_source, int n_source, int* i_target, int n_target, int syn_group, int* n_conn )
  {
    int* ret = NULL;
    BEGIN_ERR_PROP
    {
  ...
  int*
  NESTGPU_GetGroupSeqConnections( int* i_source, int n_source, int i_target, int n_target, int syn_group, int* n_conn )
  {
    int* ret = NULL;
    BEGIN_ERR_PROP
    {
  ...
  int*
  NESTGPU_GetGroupGroupConnections( int* i_source,
    int n_source,
    int* i_target,
    int n_target,
    int syn_group,
  ...
  int
  NESTGPU_GetConnectionStatus( int i_source,
    int i_group,
    int i_conn,
    int* i_target,
    unsigned char* port,
  ...
  NESTGPU_GetSynGroupParamNames( int i_syn_group )
  {
    ...
    BEGIN_ERR_PROP
    {
      ...
      for ( unsigned int i = 0; i < name_vect.size(); i++ )
      {
        ...
        std::strncpy( param_name, name_vect[ i ].c_str(), vl );
  ...
  int
  NESTGPU_ActivateSpikeCount( int i_node, int n_node )
  {
    int ret = 0;
    BEGIN_ERR_PROP
    {
  ...
  int
  NESTGPU_ActivateRecSpikeTimes( int i_node, int n_node, int max_n_rec_spike_times )
  {
    int ret = 0;
    BEGIN_ERR_PROP
    {
  ...
  int
  NESTGPU_SetRecSpikeTimesStep( int i_node, int n_node, int rec_spike_times_step )
  {
    int ret = 0;
    BEGIN_ERR_PROP
    {
  ...
  int
  NESTGPU_GetNRecSpikeTimes( int i_node )
  {
    int ret = 0;
    BEGIN_ERR_PROP
    {
  ...
  int
  NESTGPU_GetRecSpikeTimes( int i_node, int n_node, int** n_spike_times_pt, float*** spike_times_pt )
  {
    int ret = 0;
    BEGIN_ERR_PROP
    {
  ...
  int
  NESTGPU_SetNeuronGroupParam( int i_node, int n_node, char* param_name, float val )
  {
    float ret = 0.0;
    BEGIN_ERR_PROP
    {
  ...
  int
  NESTGPU_IsNeuronGroupParam( int i_node, char* param_name )
  {
    int ret = 0;
    BEGIN_ERR_PROP
    {
  ...
  float
  NESTGPU_GetNeuronGroupParam( int i_node, char* param_name )
  {
    float ret = 0;
    BEGIN_ERR_PROP
    {
