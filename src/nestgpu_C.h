...
extern "C"
{
  ...
  int NESTGPU_Connect( int i_source_node,
    int i_target_node,
    unsigned char port,
  ...
  int NESTGPU_ConnectSeqSeq( int i_source, int n_source, int i_target, int n_target );

  int NESTGPU_ConnectSeqGroup( int i_source, int n_source, int* i_target, int n_target );

  int NESTGPU_ConnectGroupSeq( int* i_source, int n_source, int i_target, int n_target );

  int NESTGPU_ConnectGroupGroup( int* i_source, int n_source, int* i_target, int n_target );
  ...
  int* NESTGPU_GetGroupGroupConnections( int* i_source,
    int n_source,
    int* i_target,
    int n_target,
    int syn_group,
    int* n_conn );
  int NESTGPU_GetConnectionStatus( int i_source,
    int i_group,
    int i_conn,
    int* i_target,
    unsigned char* port,
  ...
  int NESTGPU_ActivateRecSpikeTimes( int i_node, int n_node, int max_n_rec_spike_times );

  int NESTGPU_SetRecSpikeTimesStep( int i_node, int n_node, int rec_spike_times_step );

  int NESTGPU_GetNRecSpikeTimes( int i_node );

  int NESTGPU_GetRecSpikeTimes( int i_node, int n_node, int** n_spike_times_pt, float*** spike_times_pt );
  ...
  int NESTGPU_SetNeuronGroupParam( int i_node, int n_node, char* param_name, float val );
